...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-accent text-[#0b0e11] hover:bg-[#29ddff]",
        secondary: "bg-[#1b2230] text-foreground hover:bg-[#232a33]",
        outline:
          "border border-[#232a33] bg-transparent text-foreground hover:bg-[#151a21]",
        ghost: "text-muted hover:bg-[#151a21] hover:text-foreground",

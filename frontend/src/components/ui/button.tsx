...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-accent text-[#000000] hover:bg-[#ffffff]",
        secondary: "bg-[#111111] text-foreground hover:bg-[#1f1f1f]",
        outline:
          "border border-[#1f1f1f] bg-transparent text-foreground hover:bg-[#0a0a0a]",
        ghost: "text-muted hover:bg-[#0a0a0a] hover:text-foreground",
